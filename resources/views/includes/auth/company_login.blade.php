...
<input type="text" class="form-control form-control-lg"  id="company_id" name="tenant_id" placeholder="{{ __('tenants.enter_your_tenant_id') }}" required>
</div>
<div class="form-group">

<label for="company_id">{{ __('tenants.domain') }}</label>
<input type="text" class="form-control form-control-lg"  id="domain" name="domain" placeholder="{{ __('tenants.enter_your domain') }}" required>
</div>
