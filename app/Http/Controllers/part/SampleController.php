...
class SampleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $samples = Sample::select('id', 'name', 'status', 'description')->with('sample_items')->orderBy("created_at", "desc")->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('samples.index')->with('success', __('general.created_successfully'));
    }
